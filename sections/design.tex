...
\lst{\acrshort{gpio} configuration for \gls{adc}}{code:adc-gpioc-conf}{35}{48}{src/analog.c}
...
\lst{\acrshort{adc} configuration}{code:adc-conf}{50}{74}{src/analog.c}
...
\lst{\acrshort{dac} configuration}{code:dac-init}{78}{92}{src/analog.c}
...
\lst{\acrshort{spi}, GPIOB, GPIOC clock enable}{code:lcd-init-clocks}{15}{21}{src/lcd.c}
...
\lst{\acrshort{spi} pin mode configuration}{code:lcd-init-output}{23}{30}{src/lcd.c}
...
\lst{\acrshort{spi} pin output configuration}{code:lcd-init-output-conf}{32}{45}{src/lcd.c}
...
\lst{\acrshort{tim3} configuration}{code:lcd-tim3-conf}{47}{62}{src/lcd.c}
...
\lst{\acrshort{spi} initialization}{code:spi-init}{64}{78}{src/lcd.c}
...
\lst{\acrshort{lcd} initialization}{code:lcd-init}{80}{114}{src/lcd.c}
...
\lst{\acrshort{tim2} initialization}{code:fm-init-tim2}{102}{115}{src/analog.c}
...
\lst{\acrshort{nvic} configuration}{code:fm-init-nvic}{117}{137}{src/analog.c}
